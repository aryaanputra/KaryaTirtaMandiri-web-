...
<head>
  ...
  <title>Detail Kendaraan | Karya Tirta Mandiri</title>
          ...
          <div class="page-heading">
            <div class="page-heading-copy">
              ...
              <div>
                ...
                <h1 class="h3 mb-1">Detail Kendaraan</h1>
                <p class="text-muted mb-0">Inspect account status, profile data, permissions, and recent activity.</p>
              </div>
            </div>
            <div class="heading-actions"><a class="btn btn-outline-secondary btn-sm" href="kendaraan.php"><i class="bi bi-arrow-left" aria-hidden="true"></i>Kembali</a><a class="btn btn-primary btn-sm" href="tambah_kendaraan.php"><i class="bi bi-person-plus" aria-hidden="true"></i>Tambah Data</a></div>
          </div>

          <section class="row g-3">
              <div class="panel mb-3">
                <div class="panel-header"><div><h2 class="h5 mb-1 section-title"></h2></div><button class="btn btn-primary btn-sm" type="button" onclick="window.location.href='edit_kendaraan.php?id_kendaraan=<?= $user['id_kendaraan']; ?>'">Edit kendaraan</button></div>
                <div class="row g-3">
                <div class="info-list mt-4 text-start">
                        <div>
                            <span>
                                ID kendaraan: 
                                <strong><?= $user['id_kendaraan']; ?></strong>
                            </span>
                        </div>
                        <div>
                            <span>
                                Merk kendaraan: 
                                <strong><?= $user['merk_kendaraan']; ?></strong>
                            </span>
                        </div>
                        <div>
                            <span>
                                Plat nomor:
                                <strong><?= $user['platnomor']; ?></strong>
                            </span>
                        </div>
                    </div>
              </div>
