...
$query = mysqli_query($koneksi, "SELECT * FROM tb_pelanggan ORDER BY id_pelanggan ASC");
?>
        ...
        <div class="container-fluid px-3 px-lg-4 py-4">
          <div class="page-heading">
            <div class="page-heading-copy">
              ...
              <div>
                ...
                <p class="text-muted mb-0">Mengelola data pelanggan.</p>
              </div>
            </div>
            <div class="heading-actions"><a class="btn btn-outline-secondary btn-sm" href="tables.html"><i class="bi bi-download" aria-hidden="true"></i> Cetak Data</a><a class="btn btn-primary btn-sm" href="tambah_pelanggan.php"><i class="bi bi-person-plus" aria-hidden="true"></i>Tambah Data</a></div>
          </div>
          ...
          <section class="panel mt-3">
            <div class="panel-header">
              <div>
                <h2 class="h5 mb-1 section-title"><i class="bi bi-table" aria-hidden="true"></i><span>Data pelanggan</span></h2>
                <p class="text-muted mb-0">Mencari, meninjau, dan mengelola data pelanggan.</p>
              </div>
              ...
              <table class="table align-middle mb-0" id="usersTable" data-searchable-table>
                ...
                <?php while($row = mysqli_fetch_assoc($querycari)) { ?>
                    <tr>
                        ...
                        <td><?= $row['no_telp']; ?></td>
                        <td class="text-end">
                            <a class="btn btn-light btn-sm" href="detail_pelanggan.php?id_pelanggan=<?= $row['id_pelanggan']; ?>">View </a>
                            <a class="btn btn-danger btn-sm" href="proses_hapus_data_pelanggan.php?id_pelanggan=<?= $row['id_pelanggan']; ?>" onclick="return confirm('Yakin ingin menghapus data pengguna ini?')">Delete </a>
                        </td>
                    </tr>
                <?php } ?>
                </tbody>
