...
$query = mysqli_query($koneksi,
    "SELECT * FROM tb_pelanggan WHERE id_pelanggan='$id_pelanggan'");
...
<head>
  ...
  <title>Pelanggan | Karya Tirta Mandiri</title>
      ...
      <nav class="navbar admin-navbar navbar-expand bg-white">
        <div class="container-fluid px-3 px-lg-4">
          ...
          <form class="d-none d-md-flex ms-3 flex-grow-1" role="search">
            <input class="form-control search-input" type="search" placeholder="Cari pelanggan" aria-label="Search">
          </form>
          ...
          <div class="page-heading">
            <div class="page-heading-copy">
              ...
              <div>
                ...
                <p class="text-muted mb-0">Mengubah data Pelanggan.</p>
              </div>
            </div>
            <div class="heading-actions"><a class="btn btn-outline-secondary btn-sm" href="pelanggan.php"><i class="bi bi-arrow-left" aria-hidden="true"></i> Kembali</a></div>
          </div>

          <section class="row g-3">
            <div class="col-12 col-xl-8">
              <form class="panel needs-validation" method="POST" action="proses_edit_data_pelanggan.php" novalidate>
                <input type="hidden" name="id_pelanggan" value="<?= $user['id_pelanggan']; ?>">
                    <div class="row g-3">
                    <div class="col-md-6">
                        <label class="form-label">ID pelanggan</label>
                        <input class="form-control" type="text" id="id_pelanggan" name="id_pelanggan" value="<?= $user['id_pelanggan']; ?>" disabled>
                    </div>
                    <div class="col-md-6">
                        <label class="form-label">Nama Pelanggan</label>
                        <input class="form-control" type="text" id="nama_pelanggan" name="nama_pelanggan" value="<?= $user['nama_pelanggan']; ?>" required>
                    </div>
                    <div class="col-md-6">
                ...
                <div class="d-flex flex-wrap justify-content-end gap-2 mt-4">
                    <a class="btn btn-outline-secondary" href="pelanggan.php">Batal</a>
            ...
            <div class="col-12 col-xl-4">
              <div class="panel h-100">
                ...
                <div class="activity-list">
                  ...
                  <div class="activity-item"><span class="activity-dot bg-warning"></span><div><p class="mb-1 fw-semibold">Send invite</p><p class="text-muted small mb-0">kendaraan receive activation by email.</p></div></div>
                </div>
              </div>
            </div>
          </section>
