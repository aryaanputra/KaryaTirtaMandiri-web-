              ...
              <table class="table align-middle mb-0" id="usersTable" data-searchable-table>
                ...
                <?php while($row = mysqli_fetch_assoc($querycari)) { ?>
                    <tr>
                        ...
                        <td><?= $row['tanggal']; ?></td>
                        <td class="text-end">
                            <a class="btn btn-light btn-sm" href="detail_pemesanan.php?id_pemesanan=<?= $row['id_pemesanan']; ?>">View </a>
                            <a class="btn btn-danger btn-sm" href="proses_hapus_data_pemesanan.php?id_pemesanan=<?= $row['id_pemesanan']; ?>" onclick="return confirm('Yakin ingin menghapus data pengguna ini?')">Delete </a>
                        </td>
                    </tr>
                <?php } ?>
                </tbody>
