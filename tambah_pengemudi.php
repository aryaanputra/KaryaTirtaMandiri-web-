        ...
        <div class="container-fluid px-3 px-lg-4 py-4">
          ...
          <section class="row g-3">
            <div class="col-12 col-xl-8">
              <form class="panel needs-validation" method="POST" action="proses_tambah_data_pengemudi.php" novalidate>
                <div class="row g-3">
                    <div class="col-md-6">
                        <label class="form-label">ID pengemudi</label>
                        <input class="form-control" type="text" id="id_pengemudi" name="id_pengemudi" value="<?= $id_pengemudi; ?>" readonly>
                    </div>
                    <div class="col-md-6">
                        <label class="form-label">Nama pengemudi</label>
                        <input class="form-control" type="text" id="nama_pengemudi" name="nama_pengemudi" required>
                    </div>
                    <div class="col-md-6">
                    ...
                    <div class="col-md-6">
                        ...
                        <input class="form-control" type="text" id="alamat_pengemudi" name="alamat_pengemudi" required>
                    </div>
                    <div class="col-md-6">
                    ...
                    <div class="col-md-6">
                        ...
                        <input class="form-control" type="number" id="nomor_sim" name="nomor_sim" required>
                    </div>
                    <div class="col-md-6">
                        <label class="form-label">Masa Berlaku</label>
                        <input class="form-control" type="date" id="masa_berlaku" name="masa_berlaku" required>
                    </div>
                    <div class="col-md-6">
                    ...
                    <div class="col-md-6">
                        ...
                        <input class="form-control" type="number" id="nomor_kontak_darurat" name="nomor_kontak_darurat" required>
                    </div>
                    <div class="col-md-6">
