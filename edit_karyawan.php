...
$query = mysqli_query($koneksi,
    "SELECT * FROM tb_karyawan WHERE id_karyawan='$id_karyawan'");
          ...
          <div class="navbar-actions ms-auto">
            ...
            <div class="dropdown">
              ...
              <div class="dropdown-menu dropdown-menu-end notification-menu">
                ...
                <a class="dropdown-item" href="karyawan.html">
          ...
          <div class="page-heading">
            <div class="page-heading-copy">
              ...
              <div>
                ...
                <p class="text-muted mb-0">Mengubah data karyawan.</p>
              </div>
            </div>
            <div class="heading-actions"><a class="btn btn-outline-secondary btn-sm" href="karyawan.php"><i class="bi bi-arrow-left" aria-hidden="true"></i> Kembali</a></div>
          </div>

          <section class="row g-3">
            <div class="col-12 col-xl-8">
              <form class="panel needs-validation" method="POST" action="proses_edit_data_karyawan.php" novalidate>
                <input type="hidden" name="id_karyawan" value="<?= $user['id_karyawan']; ?>">
                    <div class="row g-3">
                    <div class="col-md-6">
                        <label class="form-label">ID Karyawan</label>
                        <input class="form-control" type="text" id="id_karyawan" name="id_karyawan" value="<?= $user['id_karyawan']; ?>" disabled>
                    </div>
                    <div class="col-md-6">
                        <label class="form-label">Nama karyawan</label>
                        <input class="form-control" type="text" id="nama_karyawan" name="nama_karyawan" value="<?= $user['nama_karyawan']; ?>" disabled>
                    </div>
                    <div class="col-md-6">
                    ...
                    <div class="col-md-6">
                        ...
                        <input class="form-control" type="text" id="alamat" name="alamat" value="<?= $user['alamat']; ?>" required>
                    </div>
                    <div class="col-md-6">
                    ...
                    <div class="col-md-6">
                      ...
                      <select class="form-select" id="status_bekerja" name="status_bekerja" required>
                          <option value="Tetap"
                              <?= $user['status_bekerja'] == 'Tetap' ? 'selected' : ''; ?>>
                              Tetap
                          </option>
                          <option value="Magang"
                              <?= $user['status_bekerja'] == 'Magang' ? 'selected' : ''; ?>>
                              Magang
                          </option>
                          <option value="Kontrak"
                              <?= $user['status_bekerja'] == 'Kontrak' ? 'selected' : ''; ?>>
                              Kontrak
                          </option>
                      </select>
                    </div>
                    ...
                    <div class="col-md-6">
                        ...
                        <input class="form-control" type="number" id="nomor_telepon_darurat" name="nomor_telepon_darurat" value="<?= $user['nomor_telepon_darurat']; ?>" required>
                    </div>
                    <div class="col-md-6">
                ...
                <div class="d-flex flex-wrap justify-content-end gap-2 mt-4">
                    <a class="btn btn-outline-secondary" href="karyawan.php">Batal</a>
            ...
            <div class="col-12 col-xl-4">
              <div class="panel h-100">
                ...
                <div class="activity-list">
                  ...
                  <div class="activity-item"><span class="activity-dot bg-warning"></span><div><p class="mb-1 fw-semibold">Send invite</p><p class="text-muted small mb-0">karyawan receive activation by email.</p></div></div>
                </div>
              </div>
            </div>
          </section>
