          ...
          <div class="page-heading">
            <div class="page-heading-copy">
              ...
              <div>
                ...
                <p class="text-muted mb-0">Mengubah data kendaraan.</p>
              </div>
            </div>
              ...
              <form class="panel needs-validation" method="POST" action="proses_edit_data_kendaraan.php" novalidate>
                <input type="hidden" name="id_kendaraan" value="<?= $user['id_kendaraan']; ?>">
                    ...
                    <div class="col-md-6">
                        ...
                        <input class="form-control" type="text" id="id_kendaraan" name="id_kendaraan" value="<?= $user['id_kendaraan']; ?>" disabled>
                    </div>
                    <div class="col-md-6">
