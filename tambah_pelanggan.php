...
function generate_id_pelanggan($koneksi){
  $prefix = "PLG";
  $q = mysqli_query($koneksi, "
    SELECT MAX(CAST(SUBSTRING(id_pelanggan, 4, 3) AS UNSIGNED)) AS max_no
    FROM tb_pelanggan
    WHERE id_pelanggan LIKE 'PLG___'
  ");
  $row = mysqli_fetch_assoc($q);
  $max = (int)($row['max_no'] ?? 0);
  $next = $max + 1;
  return $prefix . str_pad((string)$next, 3, "0", STR_PAD_LEFT); // PLG001 dst
}

$id_pelanggan = generate_id_pelanggan($koneksi);
?>
<!DOCTYPE html>
<html lang="en">
<head>
  ...
  <title>Kendaraan | Karya Tirta Mandiri</title>
        ...
        <div class="container-fluid px-3 px-lg-4 py-4">
          <div class="page-heading">
            <div class="page-heading-copy">
              ...
              <div>
                ...
                <p class="text-muted mb-0">Menambahkan data pelanggan.</p>
              </div>
            </div>
          ...
          <section class="row g-3">
            <div class="col-12 col-xl-8">
              <form class="panel needs-validation" method="POST" action="proses_tambah_data_pelanggan.php" novalidate>
                <div class="row g-3">
                    <div class="col-md-6">
                        <label class="form-label">ID pelanggan</label>
                        <input class="form-control" type="text" id="id_pelanggan" name="id_pelanggan" value="<?= $id_pelanggan; ?>" readonly>
                    </div>
                    <div class="col-md-6">
                        <label class="form-label">Nama pelanggan</label>
                        <input class="form-control" type="text" id="nama_pelanggan" name="nama_pelanggan" required>
                    </div>
                    <div class="col-md-6">
