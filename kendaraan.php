...
if($keyword != ''){
    $querycari = mysqli_query($koneksi,"
        ...
        WHERE id_kendaraan LIKE '%$keyword%'
           OR merk_kendaraan LIKE '%$keyword%'
           OR platnomor LIKE '%$keyword%'
...
$query = mysqli_query($koneksi, "SELECT * FROM tb_kendaraan ORDER BY id_kendaraan ASC");
?>
        ...
        <div class="container-fluid px-3 px-lg-4 py-4">
            ...
            <div class="col-12 col-sm-6 col-xl-3">
              <article class="metric-card metric-primary">
                <div class="metric-top">
                  <span class="metric-label">Total Kendaraan</span>
          ...
          <section class="panel mt-3">
            <div class="panel-header">
              <div>
                <h2 class="h5 mb-1 section-title"><i class="bi bi-table" aria-hidden="true"></i><span>Data kendaraan</span></h2>
                <!-- <p class="text-muted mb-0">Mencari, meninjau, dan mengelola data kendaraan.</p> -->
              </div>
              ...
              <table class="table align-middle mb-0" id="usersTable" data-searchable-table>
                ...
                <?php while($row = mysqli_fetch_assoc($querycari)) { ?>
                    <tr>
                        ...
                        <td><?= $row['platnomor']; ?></td>
                        <td class="text-end">
                            <a class="btn btn-light btn-sm" href="detail_kendaraan.php?id_kendaraan=<?= $row['id_kendaraan']; ?>">View </a>
                            <a class="btn btn-danger btn-sm" href="proses_hapus_data_kendaraan.php?id_kendaraan=<?= $row['id_kendaraan']; ?>" onclick="return confirm('Yakin ingin menghapus data pengguna ini?')">Delete </a>
                        </td>
                    </tr>
                <?php } ?>
                </tbody>
