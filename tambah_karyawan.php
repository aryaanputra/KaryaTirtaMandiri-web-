...
function generate_id_karyawan($koneksi){
  $prefix = "KRY";
  $q = mysqli_query($koneksi, "
    SELECT MAX(CAST(SUBSTRING(id_karyawan, 4, 3) AS UNSIGNED)) AS max_no
    FROM tb_karyawan
    WHERE id_karyawan LIKE 'KRY___'
  ");
...
$id_karyawan = generate_id_karyawan($koneksi);
?>
<!DOCTYPE html>
<html lang="en">
<head>
        ...
        <div class="container-fluid px-3 px-lg-4 py-4">
          <div class="page-heading">
            <div class="page-heading-copy">
              ...
              <div>
                ...
                <p class="text-muted mb-0">Menambahkan data karyawan.</p>
              </div>
            </div>
          ...
          <section class="row g-3">
            <div class="col-12 col-xl-8">
              <form class="panel needs-validation" method="POST" action="proses_tambah_data_karyawan.php" novalidate>
                <div class="row g-3">
                    <div class="col-md-6">
                        <label class="form-label">ID karyawan</label>
                        <input class="form-control" type="text" id="id_karyawan" name="id_karyawan" value="<?= $id_karyawan; ?>" readonly>
                    </div>
                    <div class="col-md-6">
                    ...
                    <div class="col-md-6">
                        ...
                        <input class="form-control" type="number" id="nomor_telepon" name="nomor_telepon" required>
                    </div>
                    <div class="col-md-6">
                    ...
                    <div class="col-md-6">
                        ...
                        <input class="form-control" type="date" id="tanggal_bergabung" name="tanggal_bergabung" required>
                    </div>
                    <div class="col-md-6">
                        <label class="form-label">Nomor Rekening</label>
                        <input class="form-control" type="number" id="nomor_rekening" name="nomor_rekening" required>
                    </div>
                    <div class="col-md-6">
                    ...
                    <div class="col-md-6">
                        ...
                        <input class="form-control" type="text" id="nama_kontak_darurat" name="nama_kontak_darurat" required>
                    </div>
                    <div class="col-md-6">
                        <label class="form-label">Nomor Telepon Darurat</label>
                        <input class="form-control" type="number" id="nomor_telepon_darurat" name="nomor_telepon_darurat" required>
                    </div>
                    <div class="col-md-6">
