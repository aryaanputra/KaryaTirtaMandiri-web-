...
function generate_id_barang($koneksi){
    $prefix = "BRG";

    $q = mysqli_query($koneksi, "
        SELECT MAX(CAST(SUBSTRING(id_barang, 4, 3) AS UNSIGNED)) AS max_no
        FROM tb_barang
        WHERE id_barang LIKE 'BRG___'
    ");
...
$id_barang = generate_id_barang($koneksi);
?>
<!DOCTYPE html>
<html lang="en">
<head>
        ...
        <div class="container-fluid px-3 px-lg-4 py-4">
          ...
          <section class="row g-3">
            <div class="col-12 col-xl-8">
              <form class="panel needs-validation" method="POST" action="proses_tambah_data_barang.php" novalidate>
                <div class="row g-3">
                    <div class="col-md-6">
                        <label class="form-label">ID Barang</label>
                        <input class="form-control" type="text" id="id_barang" name="id_barang" value="<?= $id_barang; ?>" readonly>
                    </div>
                    <div class="col-md-6">
                    ...
                    <div class="col-md-6">
                        ...
                        <select class="form-select" id="kategori" name="kategori" required>
                            <option value="">-</option>
                            <option value="Air Konsumsi">Air Konsumsi</option>
                            <option value="Air Nonkonsumsi">Air Nonkonsumsi</option>
                        </select>
                    </div>
                    <div class="col-md-6">
                    ...
                    <div class="col-md-6">
                        ...
                        <input class="form-control" type="number" id="harga_beli" name="harga_beli" required>
                    </div>
                    <div class="col-md-6">
                        <label class="form-label">Harga Jual</label>
                        <input class="form-control" type="number" id="harga_jual" name="harga_jual" required>
                    </div>
                    <div class="col-md-6">
                    ...
                    <div class="col-md-6">
                        ...
                        <input class="form-control" type="text" id="alamat_supplier" name="alamat_supplier" required>
                    </div>
                </div>
