...
<head>
  ...
  <title>Detail Pelanggan | Karya Tirta Mandiri</title>
      ...
      <main class="dashboard-content">
        <div class="container-fluid px-3 px-lg-4 py-4">
          <div class="page-heading">
            ...
            <div class="heading-actions"><a class="btn btn-outline-secondary btn-sm" href="pelanggan.php"><i class="bi bi-arrow-left" aria-hidden="true"></i>Kembali</a><a class="btn btn-primary btn-sm" href="tambah_pelanggan.php"><i class="bi bi-person-plus" aria-hidden="true"></i>Tambah Data</a></div>
          </div>

          <section class="row g-3">
              <div class="panel mb-3">
                <div class="panel-header"><div><h2 class="h5 mb-1 section-title"></h2></div><button class="btn btn-primary btn-sm" type="button" onclick="window.location.href='edit_pelanggan.php?id_pelanggan=<?= $user['id_pelanggan']; ?>'">Edit pelanggan</button></div>
                <div class="row g-3">
